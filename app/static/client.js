...
function start() {
    ...
    if (document.getElementById('use-audio').checked){
        ...
        var constraints_audio = false;
    }

    var constraints = {
        audio: constraints_audio,
        video: false
    };
    ...
    if (document.getElementById('use-video').checked) {
        ...
        if (resolution) {
            ...
            constraints.video = {
                width: {ideal: parseInt(resolution[0], 0)},
                height: {ideal: parseInt(resolution[1], 0)},
                frameRate: {ideal: 5}
            };
        } else {
            constraints.video = {};
    ...
    if (constraints.audio || constraints.video) {
        ...
        if (document.getElementById('screen-sharing').checked) {
